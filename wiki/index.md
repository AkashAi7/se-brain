...
| Source | Type | Tags | Page |
|--------|------|------|------|
| Tata Steel private call notes *(From local notes — KB-Local)* | reference | tata-steel, web-iq | [Summary](sources/kb-local-tata-steel-private-notes.md) |

## Concepts
| Concept | Sources | Page |
|---------|---------|------|
| SE Onboarding Journey | 4 | [Page](concepts/se-onboarding-journey.md) |
| Staged Ramp Plan | 3 | [Page](concepts/staged-ramp-plan.md) |
| Onboarding Tooling and Resources | 2 | [Page](concepts/onboarding-tooling-and-resources.md) |
| Onboarding Platform Capabilities | 1 | [Page](concepts/onboarding-platform-capabilities.md) |
| MCEM Deal Execution | 2 | [Page](concepts/mcem-deal-execution.md) |
| Technical Win | 3 | [Page](concepts/technical-win.md) |
| Workshop and POC Delivery | 1 | [Page](concepts/workshop-and-poc-delivery.md) |
| Active Pipeline | 3 | [Page](concepts/active-pipeline.md) |
| Customer Engagement Patterns | 4 | [Page](concepts/customer-engagement-patterns.md) |
| Account Coverage and Pod Map | 3 | [Page](concepts/account-coverage-and-pod-map.md) |
| SE Skills and Growth | 2 | [Page](concepts/se-skills-and-growth.md) |

## Entities
| Entity | Type | Sources | Page |
|--------|------|---------|------|
| Ashish Arora | person | 4 | [Page](entities/ashish-arora.md) |
| Onboarding Stakeholders | roles | 4 | [Page](entities/onboarding-stakeholders.md) |
| Tata Steel | account | 3 | [Page](entities/tata-steel.md) |
| Tata Sons | account | 2 | [Page](entities/tata-sons.md) |
| Tata Agratas | account | 2 | [Page](entities/tata-agratas.md) |
| Mahindra | account | 3 | [Page](entities/mahindra.md) |
| Azure AI Foundry | tool | 5 | [Page](entities/azure-ai-foundry.md) |
| Microsoft Sales & Execution Tools | tools | 3 | [Page](entities/microsoft-sales-tools.md) |

## Comparisons
| Comparison | Page |
|-----------|------|
| Azure vs AWS — Compete Positioning | [Page](comparisons/azure-vs-aws.md) |

## Analyses
| Question | Date | Page |
|----------|------|------|
| What should a new SE do on Day 1? | 2026-06-10 | [Page](analyses/day-1-onboarding-guide.md) |
...
1. **Opportunities legacy block** — a second deal block (HDFC, Tata BigBasket, Zomato, Bajaj Finance, ~$9.45M) has account IDs conflicting with the live accounts. The 7-deal Tata/Mahindra block ($12.65M) is authoritative.
2. **Skills/HOK placeholder accounts** — skills-and-growth.json and hok-log.json reference Contoso/WingTip/Adventure Works/Northwind/Fabrikam, not the real Tata/Mahindra accounts. Structure is reliable; account names are sample data.
3. **Onboarding coverage sample vs live accounts** — the coverage sample lists different example accounts than the live accounts data.
4. **Compete gap** — compete content is AWS-centric; the real incumbent is Google Cloud.
